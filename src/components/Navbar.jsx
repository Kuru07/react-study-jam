...
const fontStyle = "font-normal leading-[35.6px] text-[30px] md:text-[25px] font-['Ghanes']"

function Navbar() {
  const[navbarOpen,setNavbarOpen] = useState(false)
  return (
    <>
    <nav className=" bg-[#D32F2F] text-[#FFFFFF] accent-[#FFEB3B] backdrop-blur-lg fixed top-0 w-full border-b-4 border-black">
      <div className="max-w-screen flex flex-col md:flex-row flex-wrap items-center justify-between mx-auto ">
        ...
        <Link to="/">
        <img src="\assets_s3\assets\images\carpelogo.svg" alt="Logo"></img>
        </Link>
        <button
